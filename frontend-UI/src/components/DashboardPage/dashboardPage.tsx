        ...
        <div >
            ...
            <div className="search-result">
                ...
                <div className="search-result1">
                    <div className="row-1">
                        <div className="div">
                            <b className="brand-name">Brand Name</b>
                        </div>
                        <div className="div1">
                            <b className="brand-name">Company</b>
                        </div>
                        <div className="div1">
                            <b className="brand-name">Active Ingredients</b>
                        </div>
                        <div className="div1">
                            <b className="brand-name">Indication</b>
                        </div>
                        <div className="div1">
                            <b className="brand-name">NDA</b>
                        </div>
                        <div className="div1">
                            <b className="brand-name">Approval Date</b>
                        </div>
                        <div className="div6">
                            <b className="brand-name">Number of NDA Filers</b>
                        </div>
                    </div>
                    <div className="row-2" id="row2Container">
                        <div className="div7">
                            <div className="ibrance">IBRANCE</div>
                        </div>
                        <div className="div8">
                            <b className="palbociclib">PALBOCICLIB</b>
                        </div>
                        <div className="div7">
                            <div className="ibrance">PFIZER INC</div>
                        </div>
                        <div className="div7">
                            <div className="ibrance">Antineoplastics</div>
                        </div>
                        <div className="div7">
                            <div className="ibrance">PALBOCICLIB</div>
                        </div>
                        <div className="div7">
                            <div className="ibrance">Feb 3, 2015</div>
                        </div>
                        <div className="div13">
                            <div className="ibrance">12</div>
                        </div>
                    </div>
                    <div className="row-1">
                        <div className="div15">
                ...
                <div className="search-result2">
                    ...
                    <div className="table-content">
                        <div className="brand-name-parent">
                            ...
                            <div className="active-ingredients1">Active Ingredients</div>
                            <div className="indication1">Indication</div>
                            <div className="nda1">NDA</div>
                            <div className="approval-date1">Approval Date</div>
                            <div className="number-of-nda1">Number of NDA Filers</div>
                        </div>
                        <div className="brand-name-parent">
                            <div className="brand-name1">Brand Name</div>
                            <div className="company1">Company</div>
                        ...
                        <div className="content">
                            <div className="row-11">
                                <div className="ibrance2">IBRANCE</div>
                                <div className="row-1-child">
                                </div>
                                <div className="ibrance2">PFIZER INC</div>
                                <div className="row-1-child">
                                </div>
                                <div className="ibrance2">PALBOCICLIB</div>
                                <div className="row-1-child">
                                </div>
                                <div className="ibrance2">Antineoplastics</div>
                                <div className="row-1-child">
                                </div>
                                <div className="tablet">Tablet</div>
                                <div className="row-1-child">
                                </div>
                                <div className="tablet">Feb 3, 2015</div>
                                <div className="row-1-child">
                                </div>
                                <div className="tablet">12</div>
                            </div>
                        </div>
                    </div>
                </div>
                                ...
                                <div id="logo_container">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="38" height="40" viewBox="0 0 38 40" fill="none">
                                        <g clip-path="url(#clip0_1_3920)">
                                            <path fill-rule="evenodd" clip-rule="evenodd" d="M11.9849 14.8712C11.9849 12.0385 14.2812 9.74219 17.1139 9.74219H18.8236C19.1855 9.74236 19.5498 9.78621 19.9061 9.84561C20.4989 9.94441 21.3154 10.1452 22.1526 10.5638C22.9965 10.9858 23.8926 11.6456 24.5737 12.6673C25.262 13.6997 25.6623 14.9994 25.6623 16.5808C25.6623 18.1622 25.262 19.4619 24.5737 20.4943C23.8926 21.516 22.9967 22.1758 22.1526 22.5979C21.3154 23.0164 20.4989 23.2173 19.9061 23.3162C19.5519 23.3751 19.191 23.4174 18.8313 23.4196H15.4042V28.5486C15.4042 29.4929 14.6388 30.2583 13.6945 30.2583C12.7503 30.2583 11.9849 29.4929 11.9849 28.5486V14.8712ZM15.4042 14.8712V20.0002L18.8241 19.9999C19.4396 19.9794 20.0747 19.8139 20.6235 19.5395C21.0617 19.3203 21.4481 19.0185 21.7286 18.5976C22.002 18.1875 22.2429 17.564 22.2429 16.5808C22.2429 15.5978 22.002 14.9742 21.7286 14.564C21.4481 14.1432 21.0619 13.8413 20.6235 13.6222C20.0747 13.3478 19.4396 13.1824 18.8242 13.1618L17.1139 13.1615C16.1696 13.1615 15.4042 13.927 15.4042 14.8712Z" fill="#242259" />
                                            <path fill-rule="evenodd" clip-rule="evenodd" d="M18.8235 38.8062C29.21 38.8062 37.63 30.3862 37.63 19.9998C37.63 9.61329 29.21 1.19336 18.8235 1.19336C8.43702 1.19336 0.0170898 9.61329 0.0170898 19.9998C0.0170898 30.3862 8.43702 38.8062 18.8235 38.8062ZM18.8235 35.3752C10.3319 35.3752 3.44812 28.4914 3.44812 19.9998C3.44812 11.5082 10.3319 4.62439 18.8235 4.62439C27.3151 4.62439 34.199 11.5082 34.199 19.9998C34.199 28.4914 27.3151 35.3752 18.8235 35.3752Z" fill="#242259" />
                                        </g>
                                        <defs>
                                ...
                                <div id="logo_container">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="35" height="40" viewBox="0 0 35 40" fill="none">
                                        <g clip-path="url(#clip0_1_3940)">
                                            <path d="M26.3581 11.8035C26.8593 11.8035 27.266 11.3967 27.266 10.8955V6.35572C27.266 4.85394 26.044 3.63185 24.5422 3.63185H23.0123C21.9899 1.48817 19.8072 0 17.2785 0H10.0149C7.48624 0 5.30357 1.48817 4.28118 3.63185H2.75121C1.24943 3.63185 0.0273438 4.85394 0.0273438 6.35572V37.2263C0.0273438 38.7281 1.24943 39.9501 2.75121 39.9501H24.5422C26.044 39.9501 27.266 38.7281 27.266 37.2263V32.6864C27.266 32.1852 26.8593 31.7785 26.3581 31.7785C25.8569 31.7785 25.4501 32.1852 25.4501 32.6864V37.2262C25.4501 37.7264 25.0424 38.1342 24.5421 38.1342H2.75121C2.25096 38.1342 1.84323 37.7265 1.84323 37.2262V6.35572C1.84323 5.85538 2.25096 5.44774 2.75121 5.44774H3.73181C3.68916 5.74558 3.6592 6.04699 3.6592 6.35572V8.17161C3.6592 8.6728 4.06599 9.07959 4.56718 9.07959H22.7263C23.2275 9.07959 23.6343 8.6728 23.6343 8.17161V6.35572C23.6343 6.04699 23.6043 5.74558 23.5617 5.44774H24.5422C25.0424 5.44774 25.4502 5.85538 25.4502 6.35572V10.8955C25.4502 11.3967 25.8569 11.8035 26.3581 11.8035ZM21.8183 7.26362H5.47508V6.35572C5.47508 3.85249 7.5116 1.81597 10.0148 1.81597H17.2785C19.7817 1.81597 21.8182 3.85249 21.8182 6.35572V7.26362H21.8183Z" fill="#242259" />
                                            <path d="M13.6468 5.44781C14.1482 5.44781 14.5547 5.04129 14.5547 4.53982C14.5547 4.03835 14.1482 3.63184 13.6468 3.63184C13.1453 3.63184 12.7388 4.03835 12.7388 4.53982C12.7388 5.04129 13.1453 5.44781 13.6468 5.44781Z" fill="#242259" />
                                            <path d="M20.9103 11.8032H6.38308C5.88189 11.8032 5.4751 12.21 5.4751 12.7112C5.4751 13.2124 5.88189 13.6191 6.38308 13.6191H20.9104C21.4116 13.6191 21.8184 13.2123 21.8184 12.7111C21.8184 12.2099 21.4115 11.8032 20.9103 11.8032Z" fill="#242259" />
                                            <path d="M16.3706 16.3433H6.38308C5.88189 16.3433 5.4751 16.7501 5.4751 17.2512C5.4751 17.7524 5.88189 18.1592 6.38308 18.1592H16.3706C16.8718 18.1592 17.2786 17.7524 17.2786 17.2512C17.2786 16.7501 16.8718 16.3433 16.3706 16.3433Z" fill="#242259" />
                                            <path d="M15.4626 20.8828H6.38308C5.88189 20.8828 5.4751 21.2896 5.4751 21.7908C5.4751 22.292 5.88189 22.6988 6.38308 22.6988H15.4627C15.9639 22.6988 16.3707 22.292 16.3707 21.7908C16.3706 21.2896 15.9638 20.8828 15.4626 20.8828Z" fill="#242259" />
                                            <path d="M20.9104 29.9624H13.6468C13.1456 29.9624 12.7388 30.3692 12.7388 30.8704C12.7388 31.3716 13.1456 31.7784 13.6468 31.7784H20.9104C21.4116 31.7784 21.8184 31.3716 21.8184 30.8704C21.8184 30.3692 21.4116 29.9624 20.9104 29.9624Z" fill="#242259" />
                                            <path d="M10.0149 29.9624H6.383C5.88189 29.9624 5.4751 30.3692 5.4751 30.8704C5.4751 31.3716 5.88189 31.7784 6.38308 31.7784H10.0149C10.5161 31.7784 10.9229 31.3716 10.9229 30.8704C10.9228 30.3692 10.516 29.9624 10.0149 29.9624Z" fill="#242259" />
                                            <path d="M16.3706 25.4229H6.38308C5.88189 25.4229 5.4751 25.8296 5.4751 26.3308C5.4751 26.832 5.88189 27.2387 6.38308 27.2387H16.3706C16.8718 27.2387 17.2786 26.8319 17.2786 26.3308C17.2786 25.8296 16.8718 25.4229 16.3706 25.4229Z" fill="#242259" />
                                            <path d="M26.3581 13.6191C21.8529 13.6191 18.1865 17.2855 18.1865 21.7907C18.1865 26.296 21.8529 29.9624 26.3581 29.9624C30.8634 29.9624 34.5297 26.296 34.5297 21.7907C34.5297 17.2855 30.8634 13.6191 26.3581 13.6191Z" fill="#242259" />
                                            <path d="M29.5493 18.2892C29.1189 18.0314 28.5615 18.1703 28.3035 18.6007L26.178 22.1435L24.2767 20.2422C23.9217 19.8872 23.3479 19.8872 22.9928 20.2422C22.6378 20.5973 22.6378 21.1711 22.9928 21.5261L25.7167 24.25C25.8865 24.4206 26.1181 24.5151 26.3578 24.5151C26.395 24.5151 26.4322 24.5133 26.4685 24.5087C26.7463 24.4743 26.9924 24.3144 27.1358 24.0747L29.8597 19.5349C30.1186 19.1045 29.9787 18.547 29.5493 18.2892Z" fill="white" />
                                        </g>
                                        <defs>
