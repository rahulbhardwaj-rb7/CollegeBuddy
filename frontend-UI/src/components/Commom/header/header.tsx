...
const MainHeader: React.FC<MainHeaderProps> = ({displaySearch}) => {
  ...
  const [region, setRegion] = useState<any>(sessionStorage.getItem('selected_region'));
    ...
    {displaySearch && (
      ...
      <div className="header-search-box">
        <div className="header-select-region">
          ...
          <select className="header-div-wrapper" onChange={handleRegionChange} value={region}>
